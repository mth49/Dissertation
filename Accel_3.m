...
T = three_two.Time;
Accel_x = three_two.myIMUax - Base.myIMUax(1:length(three_two.myIMUax));
Accel_y = three_two.myIMUay - Base.myIMUay(1:length(three_two.myIMUay));
Accel_z= three_two.myIMUaz - Base.myIMUaz(1:length(three_two.myIMUaz));
...
title("Normalised Accel 0.3-0.2m/s")
...
xlabel("Time");
ylabel("Displacement");
title("Displacement (double integration) Data 0.3-0.2m/s")