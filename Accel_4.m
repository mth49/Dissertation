...
T = four_three.Time;
Accel_x = four_three.myIMUax - Base.myIMUax(1:length(four_three.myIMUax));
Accel_y = four_three.myIMUay - Base.myIMUay(1:length(four_three.myIMUay));
Accel_z= four_three.myIMUaz - Base.myIMUaz(1:length(four_three.myIMUaz));
...
title("Normalised Accel 0.4-0.3m/s")
...
xlabel("Time");
ylabel("Displacement");
title("Displacement (double integration) Data 0.4-0.3m/s")